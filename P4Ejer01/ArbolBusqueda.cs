...
namespace P4Ejer01
{
    class ABus
    {
        ...
        public bool insertar_rec(  nodo xr , int xn)
        {
        ...
        public bool buscar (ref nodo xr, int xn)//devueleve el nodo 
        {
            if(xr==null)
            {
                return false;
        ...
        public bool buscar2(ref nodo xr, int xn, ref nodo xp)//develve el padre en xp
        {
            if (xr == null)
            {
                return false;
        ...
        public bool insertar2 (int xn, ref nodo xr)
        {
            nodo aux;
            if (xr == null)
            {
